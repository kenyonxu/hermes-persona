...
>
> ✅ **上游已修复**：`transform_llm_output` hook 的流式传输问题已被上游合并。原 PR [#29119](https://github.com/NousResearch/hermes-agent/pull/29119) 经 salvage 后以 [#31433](https://github.com/NousResearch/hermes-agent/pull/31433) 合入 main。现在所有平台（CLI / Discord / Telegram / ACP）均可正常看到 Debug 输出。
>
> <p align="center">
